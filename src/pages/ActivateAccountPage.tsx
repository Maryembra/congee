...
import { activateAccount, validateActivationToken } from '@/services/authApi'
...
export default function ActivateAccountPage() {
  ...
  useEffect(() => {
    ...
    const checkToken = async () => {
      ...
      try {
        ...
        if (!cancelled) {
          setTokenError('Ce lien est invalide, deja utilise ou expire. Demandez une nouvelle invitation a l\'administration.')
        }
      } finally {
  ...
  const passwordReady = passwordChecks.length && passwordChecks.upper && passwordChecks.lower && passwordChecks.digit
        ...
        <Card sx={{ maxWidth: 480, width: '100%', borderRadius: 3 }}>
          <CardContent sx={{ p: 4, textAlign: 'center' }}>
            ...
            <Typography color="text.secondary" sx={{ mb: 3 }}>
              Ce lien est incomplet. Demandez une nouvelle invitation a l'administration.
            </Typography>
    ...
    return (
      <Box sx={{ minHeight: '100vh', display: 'grid', placeItems: 'center', bgcolor: '#f8fafc' }}>
        <Stack alignItems="center" spacing={2}>
          <CircularProgress />
          <Typography color="text.secondary">Verification du lien d'activation...</Typography>
        </Stack>
      </Box>
    )
  }
        ...
        <CardContent sx={{ p: { xs: 3, md: 4 } }}>
          <Stack spacing={3} alignItems="center" sx={{ mb: 3 }}>
            ...
            <Box textAlign="center">
              ...
              <Typography color="text.secondary" sx={{ mt: 0.5 }}>
                Definissez votre mot de passe pour acceder a la plateforme
              </Typography>
            </Box>
          </Stack>
          ...
          {success ? (
            <Alert severity="success" icon={<CheckCircleOutline />}>
              Compte active avec succes. Redirection vers la connexion...
            </Alert>
          ) : (
